 ...
 *  Last Modified: Time-stamp: <2014-08-05 11:05:53 mike_georgiou>
 *
 *
...
void Intermediate_Velocity_Predictor_X(double***velocity_x_tilda,
                                       double*** residual_x,
  ...
  for (int k=0; k<ldz; k++){
    for (int i=0; i<ldx; i++){
      ...
      for (int j=0; j<ldy; j++){
        ...
        Coefficient_Calculator(temperature, eddy_viscosity,
                               Reynolds,
                               coefficients,
                               dy, dt,
                               implicit_scheme,
