 ...
 *  Last Modified: Time-stamp: <2014-08-07 12:04:33 mike_georgiou>
 *
 *
      ...
      else if(index==2)
        {
          ...
          for (int j = -left_2; j < ld2+right_2; j++){
            for (int i = -left_1; i < ld1+right_1; i++){
              ...
              // output_file<<grid_1[i]<<" "<<grid_2[j]<<"
              // "<<output[level][j][i]<<endl;
              output_file<<setprecision(17)<<grid_1[i]<<" ";
              output_file<<setprecision(17)<<grid_2[j]<<" ";
              output_file<<setprecision(17) <<output[level][j][i]<<endl;
      ...
      if(index==1)
        {
          for (int j = 0; j < ld2; j++){
            for (int i = 0; i < ld1; i++){
              ...
              // output_file<<grid_1[i]<<" "<<grid_2[j]<<" "<<output[j][level][i]<<endl;
            }
            output_file<<endl;
          }
          output_file.close();
      ...
      if(index==1)
        {
          for (int j = 0; j < ld2; j++){
            for (int i = 0; i < ld1; i++){
              ...
              // output_file<<grid_1[i]<<" "<<grid_2[j]<<" "<<output[i][j][level]<<endl;
            }
            output_file<<endl;
          }
          output_file.close();
